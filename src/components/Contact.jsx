      ...
      <div className="container">
        <div className="text-center mb-16">
          <h2 className="heading-lg mb-6">
            Parlons de votre <span className="yellow-underline italic">projet</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Prêt à transformer vos idées en réalité ? Contactez-nous dès aujourd'hui 
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">hello@droptechify.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+33 6 78 90 12 34</p>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center hover:bg-yellow-500 hover:text-black transition-colors">
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button type="submit" className="btn-yellow w-full text-lg py-4">
                Envoyer le message →
              </button>
