          ...
          <div className="grid lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                DropTechify transforme vos idées en solutions digitales performantes. 
                Nous accompagnons les entreprises dans leur transformation numérique 
                avec expertise et passion.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-yellow-500 hover:text-black transition-colors">
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-center py-6">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 DropTechify. Tous droits réservés.
            </div>
            <div className="flex items-center space-x-6">
              ...
              <button 
                onClick={scrollToTop}
                className="w-8 h-8 bg-yellow-500 text-black rounded-lg flex items-center justify-center hover:bg-yellow-400 transition-colors"
              >
