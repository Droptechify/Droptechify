        ...
        <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl p-6 md:p-10">
          ...
          <div className="prose prose-yellow max-w-none">
            ...
            <ul>
              ...
              <li><p><strong>Website</strong> refers to Droptechify, accessible from <a href="https://droptechify.com/" rel="external nofollow noopener" target="_blank">https://droptechify.com/</a></p></li>
            ...
            <ul>
              <li>By visiting this page on our website: <a href="https://droptechify.com/contact" rel="external nofollow noopener" target="_blank">https://droptechify.com/contact</a></li>
            </ul>
          </div>
        </div>
      </div>
